                        ...
                        @can('view', $key)
                            <tr>
                                ...
                                <td class="d-flex flex-wrap">
                                    <a class="btn btn-sm btn-info me-1 mb-1 text-white" href="/dashboard/vendor/product/{{ $key->id }}"> {{ __('View') }} </a>
                                    <a class="btn btn-sm btn-primary me-1 mb-1" href="/dashboard/vendor/product/{{ $key->id }}/edit"> {{ __('Edit') }} </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="/dashboard/vendor/product/{{ $key->id }}" method="post">
                                                @csrf
